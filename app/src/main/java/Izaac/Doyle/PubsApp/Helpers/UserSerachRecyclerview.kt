...
class UserSerachRecyclerview(private val accounts:ArrayList<FBAccountNameModel>):RecyclerView.Adapter<UserSerachRecyclerview.ViewHolder>(){
    /**
...
init {
     ...
     */
    override fun onBindViewHolder(holder: UserSerachRecyclerview.ViewHolder, position: Int) {
